    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.collapsable}>
                ...
                <Collapsable  title='Service' content="Nos équipes se tiennent à votre disposition pour vous fournir une expérience parfaite. N'hésitez pas à nous contacter si vous avez la moindre question." />
